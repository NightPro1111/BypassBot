        ...
        headers: {
            ...
            if (data.result) {
                ...
                const successEmbed = new EmbedBuilder()
                    ...
                    .setColor(0x00FF00)
                    .setThumbnail('https://cdn.discordapp.com/attachments/1226146343735525397/1230087500794560512/GzzfBpSm1DF6KExEZbEjxI8Uq90ES3i0.png') // Yall can change this.
                    .addFields(
