...
module.exports = {
    structure: new SlashCommandBuilder()
        .setName('hydrogen')
        .setDescription('Bypass Hydrogen')
        ...
        headers: {
            ...
            if (data.result) {
                ...
                const successEmbed = new EmbedBuilder()
                    ...
                    .setColor(0x00FF00)
                    .setThumbnail('https://cdn.discordapp.com/attachments/1226146343735525397/1230088628852756500/favicon-4.png') // Yall can change this.
                    .addFields(
