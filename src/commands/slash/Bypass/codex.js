...
module.exports = {
    ...
    run: async (client, interaction) => {
        const link = interaction.options.getString('token');
        ...
        headers: {
            ...
            if (data.result) {
                ...
                const successEmbed = new EmbedBuilder()
                    ...
                    .setColor(0x00FF00)
                    .setThumbnail('https://cdn.discordapp.com/attachments/1226146343735525397/1230174040627609620/0x0.png') // Yall can change this.
                    .addFields(
