...
module.exports = {
    structure: new SlashCommandBuilder()
        .setName('linkvertise')
        .setDescription('Bypass Linkvertise')
        ...
        headers: {
            ...
            if (data.result) {
                ...
                const successEmbed = new EmbedBuilder()
                    ...
                    .setColor(0x00FF00)
                    .setThumbnail('https://cdn.discordapp.com/attachments/1226146343735525397/1230089622072070164/images_2.jpg') // Yall can change this.
                    .addFields(
