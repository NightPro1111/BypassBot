        ...
        headers: {
            ...
            if (data.result) {
                ...
                const successEmbed = new EmbedBuilder()
                    ...
                    .setColor(0x00FF00)
                    .setThumbnail('https://cdn.discordapp.com/attachments/1226146343735525397/1230087500173672489/images_1.jpg') // Yall can change this.
                    .addFields(
